...
const About = () => (
  <div className="p-8">
    ...
    <h1 className="text-3xl lg:2xlfont-bold mb-6 text-center">
    ...
    <div className="hero bg-base-200 min-h-screen">
      <div className="hero-content flex flex-col lg:flex-row items-center lg:items-start">
        <img
          ...
          className="max-w-full lg:max-w-sm rounded-lg shadow-2xl mb-6 lg:mb-0"
          alt="Company"
        />
        <div className="text-center lg:text-left lg:ml-8">
          <h1 className="text-2xl lg:text-3xl font-bold">Our Company</h1>
